...
class _Either_0 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_6.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.is_left).concat(_descriptor_6.toValue(value_0.left).concat(_descriptor_1.toValue(value_0.right)));
  }
}
      ...
      mintShielded: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mintShielded',
                                     ...
                                     'shieldedMintDeposit.compact line 15 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_8.toValue(amount_0).concat(_descriptor_0.toValue(mintNonce_0).concat(_descriptor_6.toValue(recipient_0))),
            alignment: _descriptor_8.alignment().concat(_descriptor_0.alignment().concat(_descriptor_6.alignment()))
          },
          output: undefined,
          publicTranscript: [],
      ...
      depositShielded: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('depositShielded',
                                     'argument 1 (as invoked from Typescript)',
                                     'shieldedMintDeposit.compact line 32 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _mintShielded_0(context, partialProofData, amount_0, mintNonce_0, recipient_0)
  {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('shieldedMintDeposit.compact line 28 char 17: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _depositShielded_0(context, partialProofData, coin_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 340282366920938463463374607431768211455n) {
                      throw new __compactRuntime.CompactError('shieldedMintDeposit.compact line 37 char 20: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                    }
                    return t1;
