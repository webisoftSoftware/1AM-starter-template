...
export function TransferHeader({ board }: TransferHeaderProps) {
  return (
    <header className="panel-top">
      ...
      <div className="panel-top-actions">
        {board.walletStatus === 'detected' ? (
          ...
          >
            {board.busyAction === 'connect' ? 'Connecting...' : board.isConnected ? 'Connected to 1AM' : 'Connect 1AM'}
          </button>
        ) : (
          <>
